...
import com.avssolution.fancylivecricketscore.CricketAdapter.MatchesOneThree;
import com.avssolution.fancylivecricketscore.CricketModel.OddData;
import com.avssolution.fancylivecricketscore.R;

import java.util.ArrayList;

public class QuizFirstFragment extends MainCenterFragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        RecyclerView recyclerView =  inflate.findViewById(R.id.recyclerTeamA);
